...
Pinbo is a simple app (public pinboard) that uses exlusively Ethereum infrastructure to operate.
...
Additionally, the Pinbo app charge a small fee (currently 0.0001 ETH) for each post to fund the future development.
